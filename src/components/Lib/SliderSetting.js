...
export default function SliderSetting() {
    ...
    const handleCustom = (e) => {
        console.log(thumb.current.value);
        console.log(track.current.value);
        console.log(rail.current.value);
        envDispatch({
            type: 'SET_SLIDER',
            payload: {
                ...slider,
                ...
                thumb: thumb.current.value,
                track: track.current.value,
                rail: rail.current.value
            }
        })
    }
    ...
    return (
        <div className='DAT_Setting-Slider'>            
            <div className='DAT_Setting-Slider-Row1'>
                <input placeholder="Min: 0" className="DAT_Setting-Slider-Row1-Item1" ref={min}></input>
                <input placeholder="Nhập thanh ghi" className="DAT_Setting-Slider-Row1-Item2"></input>
                <button onClick={(e) => handleMin(e)}>Chọn</button>
            </div>

            <div className="DAT_Setting-Slider-Row2">
                <input placeholder="Max: 100" className="DAT_Setting-Slider-Row2-Item1" ref={max}></input>
                <input placeholder="Nhập thanh ghi" className="DAT_Setting-Slider-Row2-Item2"></input>
                <button onClick={(e) => handleMax(e)}>Chọn</button>
            </div>

            <div className="DAT_Setting-Slider-Row3">
                <input placeholder="Width: " className='DAT_Setting-Slider-Row3-Item1' ref={width}></input>
                <input placeholder="Height: " ref={height}></input>
                <input type='color' ref={thumb}></input>
                <input type='color' ref={track}></input>
                <input type='color' ref={rail}></input>
            ...
            <div className="DAT_Setting-Slider-Row4">
                ...
                <input placeholder="Bước kéo: "></input>
                <button>Chọn</button>
            </div>
