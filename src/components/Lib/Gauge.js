            ...
            {arr.map((data,index) => {
                return (
                    <div className="DAT_Gauge_Content_Main" key={index}>
                        <div className="DAT_Gauge_Content_Main_Data" style={{width:data.width, height:data.height}}>
                            <ReactSpeedometer                        
                        ...
                        <label style={{fontSize:props.setting.labelsize + "px", color:props.setting.labelcolor}}>{props.setting.label}</label>
                    </div>                            
                )                       
            })}
        </div>
